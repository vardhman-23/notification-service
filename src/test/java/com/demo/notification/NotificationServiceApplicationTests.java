...
import com.demo.notification.domain.repository.IdempotencyRecordRepository;
...
class NotificationServiceApplicationTests {
    ...
    void testNotificationPersistence() {
        ...
        assertThat(retrieved.get().getRecipients().get(0).getDestination()).isEqualTo("trader@example.com");
