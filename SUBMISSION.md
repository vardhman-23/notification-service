...
### 2.1 Empirical Verification Artifacts Location

All test reports and live verification outputs are permanently archived in the repository for reviewer inspection:

| Verification Artifact | Repository Path | Description |
|---|---|---|
| **Live Demo Execution Trace** | [`docs/LIVE_DEMO_RUN.md`](file:///c:/Users/jainv/.gemini/antigravity/scratch/notification-service/docs/LIVE_DEMO_RUN.md) | Full console transcript of `demo.ps1` verifying all 5 assessment scenarios live against the running server. |
| **Automated Test Report** | [`docs/TEST_REPORT.md`](file:///c:/Users/jainv/.gemini/antigravity/scratch/notification-service/docs/TEST_REPORT.md) | Complete suite results (107 tests passing) and package-by-package JaCoCo coverage metrics (98.88% line coverage). |
| **Interactive JaCoCo Coverage HTML** | `target/site/jacoco/index.html` | Visual, drill-down HTML coverage report showing covered lines and branch evaluation. |
